...
// proof of concept translation of lyff.c by @skalogryz
// modifications by @PierceNg
...
function board_init(gd: int32): int32; cdecl;
var
  c, i: int32;
  //density: double;
begin
...
begin
  // This procedure is invoked by pas2js host program during startup.
  // As such it must be present. In this library's case there is nothing to do.
end;

exports
  start name '_start',
  board_init name 'board_init',
  board_ref name 'board_ref',
  board_step name 'board_step',
